 ...
 *  1.24*10^-8 * N^.47 * T^.942 (unrounded)
******not sure which one you wanted but the less the T^(<1) fudges everything up*******
...
2(total-arrays)* 4N^2 +32+(3*8) = 8N + 88 bytes

 ~ so for a perc object with 16 bytes overhead, 4 bytes padding,
(4N^2) + 32 for array, 7 ints(7*4) and , 8N + 88 for wqu
 ~ We get 12N + 168 for a percolation object	
 ~ Using tilde to ignore low order terms we get
